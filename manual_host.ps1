# Manual Host Script
# 1. Starts Backend (Local)
# 2. Updates Frontend Config
# 3. Starts Ngrok for Frontend
# 4. Instructs user to run Frontend manually
...
Write-Host "Hosting Setup Partially Complete!" -ForegroundColor Green
Write-Host "Application URL: $frontendUrl" -ForegroundColor Yellow
Write-Host "==================================================" -ForegroundColor Green
Write-Host "IMPORTANT: You must now run the following command in a NEW terminal:" -ForegroundColor Red
Write-Host "cd app/frontend; npm start -- -H 127.0.0.1 -p 3000" -ForegroundColor Yellow
Write-Host "==================================================" -ForegroundColor Green
